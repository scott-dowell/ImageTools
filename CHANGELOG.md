...
- Issue #59: Show current file details in the UI immediately when conversion starts for each file.
- Issue #58: Disable the "Convert" and "Scan" buttons in the UI while a conversion is already in progress.
